...
export default class Tweet extends React.Component {
  ...
  constructor(props) {
    ...
    const twit = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque venenatis efficitur dui, vel tincidunt purus ultricies nec. Mauris nibh ante, ullamcorper ac commodo sit amet, imperdiet id diam. Nam a facilisis nunc, sed cursus sapien. Mauris vitae purus vitae sapien."
    this.state = {
...
const styles = StyleSheet.create({
  ...
  userName: { color: "#292929", fontWeight: "bold" },
  userHandleAndTime: {
    color: "rgb(136, 153, 166)",
    marginLeft: 5
  },
  tweetTextContainer: { flex: 1, borderColor: "blue", borderWidth: 0 },
  tweetText: { color: "#292929", paddingRight: 10 },
